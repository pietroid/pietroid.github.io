...
There are some details I left uncommented, such as how I did my styling and the Scaffold & Home content itself, but I think it's better to leave it for another post, as the styles per se are really simple and more a matter of Design than development.

Everything I just shared here is completly open source and available on [this Github repository](https://github.com/pietroid/pietroid.github.io). Take a look at the README.md and feel free to use it!